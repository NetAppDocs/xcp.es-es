...
NOTE: Los informes XCP (.csv, .html) se guardan en la ubicación del catálogo especificada en la `xcp.ini` archivo. Los archivos se almacenan en la `<catalog path>/catalog/indexes/1/reports` carpeta. Puede ver informes de muestra en el apéndice.
