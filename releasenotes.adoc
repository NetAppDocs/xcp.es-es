...
---
= Notas de la versión de XCP v1.9.1
:allow-uri-read: 


La link:https://library.netapp.com/ecm/ecm_download_file/ECMLP2884968["Notas de la versión de XCP v1.9.1"^] describa las nuevas funciones, las notas de actualización, los problemas solucionados, las limitaciones conocidas y los problemas conocidos.
