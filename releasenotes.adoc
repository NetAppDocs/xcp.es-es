...
[role="lead"]
La link:https://library.netapp.com/ecm/ecm_download_file/ECMLP3317866["Notas de la versión de XCP v1,9.4"^] describa las nuevas funciones, las notas de actualización, los problemas solucionados, las limitaciones conocidas y los problemas conocidos.
